...
* **options** (<code>[EslintOptions](#projen-eslintoptions)</code>)  *No description*
  ...
  * **aliasMap** (<code>Array<json></code>)  Enable import alias for module paths. __*Default*__: undefined
...
**aliasMap**?🔹 | <code>Array<json></code> | Enable import alias for module paths.<br/>__*Default*__: undefined
